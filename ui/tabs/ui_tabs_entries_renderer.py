...
from core.io.core_io_grub_menu_parser import GrubDefaultChoice, get_simulated_os_prober_entries
from core.managers.core_managers_entry_visibility import save_hidden_entry_ids
from ui.builders.ui_builders_widgets import clear_listbox
...
def _apply_state_buttons(controller: GrubConfigManager) -> None:
    controller.apply_state(controller.state_manager.state)
...
def _configure_entry_switch(
    ...
    *,
    ...
    def _on_switch(_sw, _pspec, *, _mid=menu_id):
        ...
        # Persiste la liste des IDs masqués (utilisé par certains tests et
        # utile pour conserver l'intention utilisateur avant l'application).
        ...
        controller.show_info("Masquage modifié. Cliquez sur Appliquer pour l'écrire.", "info")
