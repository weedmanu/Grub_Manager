...
from .theme_editors.ui_dialogs_theme_editors_base import BaseElementEditor
from .theme_editors.ui_dialogs_theme_editors_layout import BootMenuEditor, ProgressBarEditor, TerminalBoxEditor
from .theme_editors.ui_dialogs_theme_editors_text import ColorsEditor, FontsEditor, TextElementEditor
from .theme_editors.ui_dialogs_theme_editors_visual import DesktopImageEditor, IconsEditor, ImageEditor
...
class ThemeElementRow(Gtk.Box):
    ...
    def __init__(
        ...
        # Configure button
        config_btn = Gtk.Button(label="Configurer")
