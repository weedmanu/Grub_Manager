...
@pytest.fixture
def mock_generator():
    with patch("ui.dialogs.ui_dialogs_interactive_theme_generator_window.ThemeGenerator") as mock:
...
def test_interactive_theme_generator_window_create_success(mock_generator):
    ...
    with patch("ui.dialogs.ui_dialogs_interactive_theme_generator_window.Gtk") as mock_gtk:
        ...
        assert mock_gtk.AlertDialog.called
