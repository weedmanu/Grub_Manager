...
def test_init_coverage():
    ...
    with patch("ui.ui_manager.Gtk.ApplicationWindow.__init__") as mock_super_init, \
...
def test_on_save_dialog_cancel(manager):
    ...
    with patch("os.geteuid", return_value=0), \
         patch("ui.ui_manager.Gtk.AlertDialog") as MockDialog:
...
def test_on_hidden_timeout_toggled_active(manager):
    ...
    with patch("ui.ui_gtk_helpers.GtkHelper.stringlist_replace_all"), \
