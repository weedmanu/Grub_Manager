...
def ui_manager():
    ...
    with patch("ui.ui_manager.UIBuilder"), \
         patch("ui.ui_manager.AppState"), \
         patch("ui.ui_manager.AppStateManager"):
...
def test_perform_save_verification_exception(ui_manager):
    ...
    with patch("ui.ui_manager.GrubApplyManager") as MockApplyManager,          patch("ui.ui_manager.read_grub_default") as mock_read:
...
def test_perform_save_hidden_entries_exception_coverage(ui_manager):
    ...
    with patch("ui.ui_manager.merged_config_from_model"),          patch("ui.ui_manager.GrubApplyManager") as MockApplyManager,          patch("ui.ui_manager.read_grub_default"),          patch("ui.ui_manager.apply_hidden_entries_to_grub_cfg") as mock_apply:
