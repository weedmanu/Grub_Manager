...
from core.theme.theme_generator import (
    ThemeGenerator,
    ThemeResolution,
    ColorScheme,
...
class TestThemeGeneratorCoverage:
    ...
    def test_create_theme_package_validation_warning(self):
        ...
        generator = ThemeGenerator()
        theme_config = {"elements": {"boot_menu": {"enabled": True}}, "properties": {}}
        with patch("core.theme.theme_generator.core_theme_generator.ThemeValidator.validate_theme_file", return_value=(False, ["Warning"])):
