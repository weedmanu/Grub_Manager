...
from ..config.core_config_paths import GRUB_CFG_PATH
...
from ..io.core_io_grub_default import write_grub_default
from ..io.core_io_grub_validation import validate_grub_file
from ..services.core_services_grub_script import GrubScriptService
from ..system.core_system_grub_commands import resolve_executable
...
class ApplyFinalState(GrubApplyState):
    ...
    def _apply_theme_scripts(self) -> tuple[GrubScriptService, list[tuple[Path, bool]]]:
        ...
        logger.info("[ApplyFinalState] Gestion des scripts (pending_script_changes uniquement)")
